...
const restart_quiz = result_box.querySelector(".begin_start .next");
const quit_quiz = result_box.querySelector(".begin_start .leave");
...
const next_btn = document.querySelector("footer .move-on-btn");
const bottom_ques_counter = document.querySelector("footer .all-questions-asked");
...
function showQuetions(index){
    const que_text = document.querySelector(".questions-asked");
...
function showResult(){
    ...
    const scoreText = result_box.querySelector(".total_results");
    if (userScore > 3){ 
